...
namespace MecanicApp.Migrations
{
    ...
    [Migration("20260702205033_AddCamposProformaYOrdenTrabajo")]
    partial class AddCamposProformaYOrdenTrabajo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MecanicApp.Entities.Cliente", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MecanicApp.Entities.OrdenServicio", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EspecificacionAveria")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("SubtotalProductos")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("MecanicApp.Entities.OrdenServicioDetalle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OrdenServicioDetalles", (string)null);
                });

            modelBuilder.Entity("MecanicApp.Entities.OrdenServicioUsuario", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrdenServicioId", "UsuarioId")
                        .IsUnique();

                    b.ToTable("OrdenServicioUsuarios", (string)null);
                });

            modelBuilder.Entity("MecanicApp.Entities.Producto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MecanicApp.Entities.Servicio", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MecanicApp.Entities.Vehiculo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MecanicApp.Entities.OrdenServicio", b =>
                {
                    b.HasOne("MecanicApp.Entities.Vehiculo", "Vehiculo")
                        .WithMany()
            ...
            modelBuilder.Entity("MecanicApp.Entities.OrdenServicioDetalle", b =>
                {
                    b.HasOne("MecanicApp.Entities.OrdenServicio", "OrdenServicio")
                        .WithMany("Detalles")
                        .HasForeignKey("OrdenServicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MecanicApp.Entities.Producto", "Producto")
                        .WithMany()
                        .HasForeignKey("ProductoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MecanicApp.Entities.Servicio", "Servicio")
                        .WithMany()
            ...
            modelBuilder.Entity("MecanicApp.Entities.Vehiculo", b =>
                {
                    b.HasOne("MecanicApp.Entities.Cliente", "Cliente")
                        .WithMany("Vehiculos")
